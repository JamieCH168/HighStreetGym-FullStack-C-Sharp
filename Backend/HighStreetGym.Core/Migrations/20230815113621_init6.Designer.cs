...
namespace HighStreetGym.Core.Migrations
{
    ...
    [Migration("20230815113621_init6")]
    partial class init6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HighStreetGym.Domain.Class", b =>
                {
                    b.HasOne("HighStreetGym.Domain.Activity", null)
                        .WithMany("Classes")
                        .HasForeignKey("activity_id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("HighStreetGym.Domain.Room", null)
                        .WithMany("Classes")
                        .HasForeignKey("room_id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("HighStreetGym.Domain.User", null)
                        .WithMany("Classes")
